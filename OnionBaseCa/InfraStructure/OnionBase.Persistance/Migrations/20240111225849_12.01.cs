...
{
    public partial class _1201 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Link = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CodeFor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CodeFors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CampaignCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Campaigns", x => x.CampaignCode);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CampaignCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    confirmationRequest = table.Column<bool>(type: "bit", nullable: false),
                    isConfirmed = table.Column<bool>(type: "bit", nullable: false),
                    Shipping = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitedDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisitedDatas_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitedDatas_ProductId",
                table: "VisitedDatas",
                column: "ProductId");
        }
